...
# simulate for KnotGridSearch with sample_size = 5000, knot = 10, varying intercept
temp <- data.frame()

for (intercept in c(-4, -2.5, -1.5, 0)){
    result <- simulation_output(sample_size = 5000, knot = 10, intercept = intercept, method  = "GridSearchKnot")
