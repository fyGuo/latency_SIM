...
# Bimodal weighting: mixture of two Gaussians, modes at lag 3 and lag 12.
# B = -1: second mode is negative (used throughout this folder).
alpha_function <- function(l, A = 0.3, B = -1){
